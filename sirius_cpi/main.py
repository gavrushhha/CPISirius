...
department_question_weights = {
    ...
    "ДПО": {
        ...
        "Оцените полезность и доступность информации   ": 15,
        "Оцените соотношение теории и практики   ": 5, 
        "Оцените наполнение практических занятий   ": 5,
        "Оцените полноту и доступность ответов на вопросы аудитории   ": 5, 
        "Оцените информационное сопровождение до начала и в течение программы организаторами   ": 5, 
        "Оцените материально-техническое обеспечение программы   ": 5,
        "Оцените питание и проживание   ": 10,
    ...
    "ЦРТО": {
        ...
        'Как вы оцениваете качество и сроки проведения пуско-наладочных работ?': 15,
        ...
        'Как вы оцениваете качество и сроки проведения планового технического обслуживания оборудования?': 15,
        ...
        # 'Какая в целом ваша оценка работы подразделения?': 20,
        'Как вы оцениваете качество и сроки проведения ремонта оборудования?': 15,
        'Как вы оцениваете качество и сроки метрологического обеспечения оборудования (поверка, аттестация)?': 15,
        'Как вы оцениваете качество и сроки снабжения медицинскими газами и криожидкостями?': 10,
        'Как вы оцениваете информационную систему подачи заявок ServiceDesk "Сервис лабораторного оборудования" для обращений в ЦРТО?': 10,
        'Какая в целом ваша оценка работы подразделения?': 20,
    },

    "Ресурсные центры": {
        "Как вы оцениваете качество/достоверность предоставляемых результатов?": 40,
        "Как вы оцениваете время выполнения сервисных услуг?": 40,
    ...
    # },
        ...
        "Группа содержания лабораторных помещений_ОЛП": {
            "Как вы оцениваете работу группы содержания лабораторных помещений (группы клининга) в общем?": 10,
            "Как вы оцениваете качество ежедневной и генеральной уборки в лабораторных помещениях и местах общего пользования?": 50,
            "Как вы оцениваете работу администратора ЛК?": 40,

    },

        "Группа общелабораторного сервиса_ОЛП": {
            "Как вы оцениваете работу группы общелабораторного сервиса в общем?": 10,
            "Как вы оцениваете лабораторную уборку, которую проводят лаборанты ОЛП?": 50,
            "Как вы оцениваете сервис стерилизации и мытья посуды?": 20,
            "Как вы оцениваете сервис обеспечения СИЗ (выдача, стирка, возврат)?": 20,

    },

        "Группа лабораторного обеспечения_ОЛП": {
            "Как вы оцениваете работу группы по лабораторному обеспечению в общем?": 10, 
            "Как вы оцениваете сервис обработки и технического заведения вашей заявки на закупку в 1С:УХ?": 30, 
            "Как вы оцениваете сервис доставки ТМЦ со складов НТУ и ЛК?": 30,
            "Как вы оцениваете  удобство работы с реестрами (оборудования, реактивов и материалов, ЛВЖ)?": 30, 
...
department_question_no_weights_second = {
    ...
    "Группа содержания лабораторных помещений_ОЛП": [
            ...
            "Как вы оцениваете работу Легчило Натальи Алексеевны?",
    ...
    "Группа лабораторного обеспечения_ОЛП": [
            ...
            "Как вы оцениваете работу Смотровой Ксении Александровны?",
            "ак вы оцениваете работу Старостиной Ирины Александровны?",
    ...
    "РЦ_БМ": [
        "Оцените работу Демьяненко Ильи Александровича",
    ...
    "РЦ_БП": [
        ...
        "Оцените работу Конышковой Дарьи Андреевны", 
    ...
    "РЦ_КТ": [
        ...
        "Оцените работу Кордоновой Анны Вадимовны", 
    ],
    "РЦ_МИС": [
